    <div class="row noMargin">
      <div class="col-12" style="background-image: url(assets/img/img1.jpg);background-size: cover;background-repeat: no-repeat;">
        <div class="row noMargin">
          <div class="col-12"style="padding:30px 0px 50px 60px">
            <h1 class=" white">UN LOGICIEL DE GESTION DE STOCK</h1>
          </div>
        <div class="row noMargin justify-content-center">
          <div class="col-lg-6 col-md-12 align-self-center">
            <div class="row noMargin" style="padding:30px 0px 0px 0px">
              <div class="col-2 offset-1"style="display: inline;">
                <img src="assets/img/encoche.png" alt="encoche">
              </div>
              <div class="col-9">
                <h3 class=" white">Gestion du stock</h3>
              </div>
            </div>
            <div class="row noMargin" style="padding:30px 0px 0px 0px">
              <div class="col-2 offset-1"style="display: inline;">
              ...
              <div class="col-9">
                <h3 class=" white">Gestion des fournisseur</h3>
              </div>
            </div>
            <div class="row noMargin" style="padding:30px 0px 0px 0px">
              <div class="col-2 offset-1"style="display: inline;">
              ...
              <div class="col-9">
                <h3 class=" white">Gestion des commande</h3>
              </div>
            </div>
            <div class="row noMargin" style="padding:30px 0px 0px 0px">
              <div class="col-2 offset-1"style="display: inline;">
              ...
              <div class="col-9">
                <h3 class=" white">Catégorisation des produit</h3>
              </div>
            </div>
            <div class="row noMargin" style="padding:30px 0px 30px 0px">
              <div class="col-6">
                <button class="btn bouton" type="button" name="button">C'est quoi ?</button>
              </div>
              <div class="col-6">
                <button class="btn bouton" type="button" name="button">Comment ça marche ?</button>
              </div>
            </div>
          </div>
          <div class="col-lg-6 col-md-12 align-self-center">
            <img class="img-fluid" src="assets/img/Power28-accueil(3).png" alt="home page application">
          </div>
        </div>
        </div>
      </div>
    ...
    <div class="row noMargin">
      <div class="col-12">
        <h1 class=" black center">géré votre stock avec Power28</h1>
      </div>
    </div>
    <div class="row noMargin">
      <div class="col-12">
        <h4 class=" dark_grey center">pour les TPE et PME</h4>
      </div>
    </div>
